...
//*   }
//*
//* as well as VectorRenderer   and RasterRenderer  classes. Each implementer of the Shape  interface should have a constructor that takes an
//* Renderer  such that, subsequently, each constructed object's toString()  operates correctly and produces a message similar to the following:
...
//{
//    public Square(VectorRenderer vectorRenderer) {
//        super();
//    }
//
//    @Override
